...
const theme = document.getElementsByClassName("themebutton");
let global = false;
...
//Toggle theme
// const themeTG = document.getElementById("theme-tog");

// function toggleDM(){
//     document.body.classList.toggle("dark-mode");
// }
// themeTG.addEventListener('click',toggleDM);

// let flag = true;

// function collapse(collapseDiv){
//     if(flag){
//         flag === false;
...
//     }
// }
// let collapseDiv = document.getElementById("collapse");
// let explore = document.getElementById("explore");
// let subscriptions = document.getElementById("subscriptions");

// explore.addEventListener("click",collapse(collapseDiv));
// subscriptions.addEventListener("click",collapse(collapseDiv));